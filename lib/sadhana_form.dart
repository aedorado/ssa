...
class _SadhanaFormState extends State<SadhanaForm> {
  ...
  _updateSelectedMinMaxDates() {
    if (widget.editMode) {
      ...
      selectedDatePlus1 = widget.sadhanaForDate!.add(const Duration(days: 1));
    } else {
      selectedDateMinus1 = widget.today!.subtract(const Duration(days: 1));
      selectedDatePlus1 = widget.today!.add(const Duration(days: 1));
        ...
        child: Column(
          ...
          children: [
                    ...
                    onPressed: () => _showDialog(
                          CupertinoDatePicker(
                            ...
                            onDateTimeChanged: (DateTime newDate) {
                              setState(() => widget.sadhanaForDate = newDate);
                            },
                          ),
                        ),
                    child: Text(
            ...
            CupertinoButton(
              ...
              onPressed: () => _showDialog(
                CupertinoDatePicker(
                  initialDateTime: widget.lastNightSleepTime,
            ...
            CupertinoButton(
              ...
              onPressed: () => _showDialog(
                CupertinoDatePicker(
                  initialDateTime: widget.todaysWakeUpTime,
                  minimumDate: selectedDateMinus1,
                  maximumDate: selectedDatePlus1,
                  use24hFormat: true,
                  // This is called when the user changes the dateTime.
            ...
            CupertinoButton(
              ...
              onPressed: () => _showDialog(
                CupertinoDatePicker(
                  initialDateTime: widget.sixteenRoundsCompletedTime,
                  minimumDate: selectedDateMinus1,
                  maximumDate: selectedDatePlus1,
                  use24hFormat: true,
                  // This is called when the user changes the dateTime.
